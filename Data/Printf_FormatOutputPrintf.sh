...
function printf_FormatOutputprintf(){
    ...
    echo
    echo " Not Option : %s [String], %f [Float], %d [Int] "
    ...
    echo
    echo " Not Option : %[-n]s [ Right blank ], %[+n]s [ Left blank ] "
    ...
    echo 
    echo " Not Option : %[n]d [ Left blank ], %0[n]d [ Left 0 ], %[n.m]f [ Int n, Float m ] "
    ...
    echo
    echo " Not Option -v : Variable Set "
